...
<div style="margin-left:40%;">
	<form action='?page=editproject' method='post' style = "float:left; padding-top:30px">
		...
		<p> 
			<label>Product client:<br>
				<input type = "text" value="<?php echo $client; ?>" id = "projectclient" name="projectclient" placeholder = "Project client" required style="border-radius:5px; margin-top:5px"/>
			</label>
		</p>
		<p> 
			<label>Start date:
